...
<table>
   ...
   <p>&emsp;&emsp;<a href="https://gh-proxy.com/https://raw.githubusercontent.com/BernieMacMillan/NebulaChainSystem/main/windows/ncsystem-4.4.7.exe" target="_blank">
   ...
   ```text
   https://gh-proxy.com/https://raw.githubusercontent.com/BernieMacMillan/NebulaChainSystem/main/windows/ncsystem-4.4.7.exe
   ```

   ```text
   https://gh.idayer.com/https://raw.githubusercontent.com/BernieMacMillan/NebulaChainSystem/main/windows/ncsystem-4.4.7.exe
   ```
