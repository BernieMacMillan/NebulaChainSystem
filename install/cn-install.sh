...
VERSION="3.7.3"
DOWNLOAD_HOST="https://tinyurl.com/2hxn7r95"
...
if [ "$lang_choice" = "1" ]; then
    ...
    prompt_port="6. 修改NCSystem启动端口"
    prompt_ulimit="7. 解除Linux系统连接数限制（需要重启服务器生效）"
    prompt_auto_start="8. 设置NCSystem开机启动"
    prompt_disable_auto_start="9. 关闭NCSystem开机启动"
    prompt_status="10. 查看NCSystem运行状态"
    prompt_error_log="11. 查看NCSystem错误日志"
    prompt_clear_log="12. 清理NCSystem日志文件"
    prompt_web_port="13. 查看NCSystemWEB访问端口"
    prompt_uninstall="14. 卸载NCSystem程序"
    prompt_reset_pwd="15. 重置NCSystem账号密码"
